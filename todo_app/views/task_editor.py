...
class TaskEditorDialog(ctk.CTkToplevel):
    ...
    def _build(self) -> None:
        ...
        ctk.CTkLabel(
            ...
            font=ctk.CTkFont(size=12, weight="bold"),
            text_color=THEME.color("text_muted"),
        ).grid(row=6, column=0, sticky="w", padx=4)
        ctk.CTkLabel(
            outer,
            text="Repeat",
            font=ctk.CTkFont(size=12, weight="bold"),
        ...
        ctk.CTkButton(
            date_row, text="Clear", width=60, height=28, command=lambda: self.start_date.set_date(_dt.date.today())
        ...
        ctk.CTkButton(
            date_row, text="Clear", width=60, height=28, command=lambda: self.due_date.set_date(_dt.date.today())
        ...
        ctk.CTkLabel(
            ...
            font=ctk.CTkFont(size=12, weight="bold"),
            text_color=THEME.color("text_muted"),
        ).grid(row=10, column=0, sticky="w", padx=4)
        ctk.CTkLabel(
            outer,
            text="Reminder",
            font=ctk.CTkFont(size=12, weight="bold"),
        ...
        self.duration_entry = ctk.CTkEntry(outer, height=36, corner_radius=10,
        ...
        ctk.CTkLabel(
            ...
            font=ctk.CTkFont(size=12, weight="bold"),
            text_color=THEME.color("text_muted"),
        ).grid(row=12, column=0, sticky="w", padx=4)
        ctk.CTkLabel(
            outer,
            text="Progress (%)",
            font=ctk.CTkFont(size=12, weight="bold"),
        ...
        for color in COLOR_TAGS:
            rb = ctk.CTkRadioButton(
                color_row, text="", value=color, variable=self.color_var,
                fg_color=color, hover_color=color, width=22, height=22
            )
        ...
        ctk.CTkLabel(
            ...
            font=ctk.CTkFont(size=12, weight="bold"),
            text_color=THEME.color("text_muted"),
        ).grid(row=15, column=0, columnspan=2, sticky="w", padx=4)
        self.notes_text = ctk.CTkTextbox(outer, height=80, corner_radius=10)
        self.notes_text.grid(row=16, column=0, columnspan=2, sticky="ew", padx=4, pady=(2, 12))

        # Toggles
        toggles = ctk.CTkFrame(outer, fg_color="transparent")
        toggles.grid(row=17, column=0, columnspan=2, sticky="ew", padx=4, pady=(0, 12))
